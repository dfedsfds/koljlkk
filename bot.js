...
client.on('message', function(message) {
    ...
    client.channels.get("532631479596089344").send({embed:RaYaN});
    }
});
...
client.on("message", (message) => {
 ...
 client.on('message', message => {
  ...
  .setFooter(`Lina`, 'https://images-ext-2.discordapp.net/external/X9SanEG0s7Dtv3krTgy-kod_fj6JRVJ2AG4JryCiiz0/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/375761288518828042/fffa31c797e88cf059dd6db424ff456a.png?width=80&height=80')
  .setColor("#000000")
